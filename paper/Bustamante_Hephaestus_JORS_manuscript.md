...
| CALPHAD, XML successor | XTDB [15] | unified XML schema, MQMQA and third-generation models included; read by this engine |
...
![Figure 1: Architecture of Hephaestus. A single dependency-free C core reads the field's database dialects (ChemSage .dat, Thermo-Calc .tdb with the Inden magnetic model, and the unified .utdb) and calculates all thermodynamics; the same core is used as a native library, from Python through cffi, and compiled to WebAssembly behind the browser application. The browser build adds a reader for the XML XTDB successor and its third-generation (Einstein heat capacity, two-state liquid) models. dbbuild writes new ChemSage files from measured data, and every energy path is validated against pycalphad.](figures/fig1_architecture.png){width=6.3in}
...
| MgO-SiO~2~ | five terms in the equivalent fraction Y~SiO2~, each a + b T | measured invariants and immiscibility data [25,26] from five studies, the measured consolute, and solution calorimetry [27] | all four invariants within about 40 K; calorimetry matched; stable two-liquid field about 340 K high |
| FeO-SiO~2~ | -42839 + 17.83 T | 23 iron-saturated activities across two isotherms [23] | RMS ln a = 0.067; fayalite congruent melting within a few kelvin |
...
| CaO-Al~2~O~3~ | (-156581 + 2.16 T) + 133468 χ~Ca~ | six melting invariants [40] | invariants within about ±90 K (screening quality; liquid activities not yet constrained) |
| Al~2~O~3~-SiO~2~ | 9317 + 33855 χ~Si~^5^ | the cristobalite-mullite eutectic [40] | eutectic reproduced (1883 K, x~AlO1.5~ = 0.150); the alumina-rich mullite liquidus is the weak flank |
| CaO-Al~2~O~3~-SiO~2~ | binaries combined, plus one ternary term (AlO~1.5~ into the CaO-SiO~2~ quadruplet, L = -110000) | 45 KEMS silica activities [21,35] | RMS ln a 0.48 (basic corner) and 0.46 (silica-rich); ternary liquidus not yet mapped |
| CaO-FeO-MgO-SiO~2~ | four silica binaries combined; basic edges ideal; no quaternary term | assembled by the Muggianu extension | reduces to each binary exactly at its edge; the melt interior is a prediction, and the ideal basic edges a documented next step |
...
The brevity of the file is inverted in the effort behind it. Building one from scratch, as done for each system here, starts with locating and triaging the primary literature, then extracting measurements with per-value provenance, including digitization from sixty-year-old figures. Endmember functions are assembled from evaluated compilations, the model structure is chosen, and the excess is fitted with the engine as the forward model. The result is validated against an independent implementation and against measurements withheld from the fit, and the limits are written down. Because a liquidus is set by the Gibbs energy of the liquid minus that of the coexisting solid, every boundary-setting phase carries its own assessed description here, the terminal oxides and intermediate compounds from the evaluated tables and solution calorimetry and the olivine and orthopyroxene solutions from calorimetric mixing parameters, rather than being frozen as pure elements; the liquid excess is fitted against those real solid descriptions, so it is not left to absorb a missing solid contribution, and the fitted interaction stays physically transferable. The steps that resist automation are judgments: conflicting data sets must be arbitrated, reference states reconciled, and model-form limits recognized rather than papered over with additional terms. dbbuild automates the mechanical part of this pipeline; the judgment does not compress.
...
| Gas phase | NASA-polynomial ideal-gas equilibria (Python and C core); Peng-Robinson real gas | Cantera [42] parity to 10^-10^ (Python), 10^-6^ (C/browser); real-gas compressibility to 10^-3^ vs Cantera PR |
| Gas-condensed coupling | shared-element-potential solve, gas + stoichiometric metals/oxides (Boudouard, FeO reduction) | Cantera multiphase parity to 10^-3^ mole fraction, to 10^-10^ on shared thermodynamic data |
...
- Persistent identifier: https://github.com/odinzen/hephaestus-mqmqa-public/releases/tag/v0.6.0
- Licence: MIT (code), CC BY 4.0 (database)
- Publisher: Michael E. Bustamante
- Version published: v0.6.0
...
In plain terms, the session sweeps temperature and composition steps, and at each point multiphase_binary compares the liquid solution against the two solid salts and reports which phases coexist. The two stoich_gibbs lines fetch the Gibbs energies of solid LiCl and solid KCl at that temperature. The closing lines only search the results: among all points where the melt is entirely liquid, the coldest is the eutectic.

The listing prints its eutectic at x~KCl~ = 0.400 and 640 K at this deliberately coarse step size, against the measured 0.415 and 626 K; Figure 4 is the diagram it draws.

![Figure 4: The LiCl-KCl phase diagram calculated by the salt listing from the shipped open database, at the listing's own step size. Light to dark: liquid, two-phase, and subsolidus fields. The dot is the calculated eutectic at this step size (0.400, 640 K); the star is the measured eutectic (0.415, 626 K).](figures/fig4_salt_example.png){width=4.6in}
...
[22] Stolyarova VL, Shornikov SI, Ivanov GG, Shultz MM. High Temperature Mass Spectrometric Study of Thermodynamic Properties of the CaO-SiO2 System. J Electrochem Soc. 1991 Dec 1;138(12):3710–4. doi:10.1149/1.2085485

[23] Björkman B. An assessment of the system Fe-O-SiO2 using a structure based model for the liquid silicate. Calphad. 1985 Jul;9(3):271–82. doi:10.1016/0364-5916(85)90012-4

[24] Bowen NL, Schairer JF. The system MgO-FeO-SiO2. American Journal of Science. 1935 Feb 1;s5-29(170):151–217. doi:10.2475/ajs.s5-29.170.151
...
[27] Charlu TV, Newton RC, Kleppa OJ. Enthalpies of formation at 970 K of compounds in the system MgO-Al2O3-SiO2 from high temperature solution calorimetry. Geochimica et Cosmochimica Acta. 1975 Nov;39(11):1487–97. doi:10.1016/0016-7037(75)90150-7
...
[34] Wu P, Eriksson G, Pelton AD, Blander M. Prediction of the Thermodynamic Properties and Phase Diagrams of Silicate Systems-Evaluation of the FeO-MgO-SiO2 System. ISIJ International. 1993;33(1):26–35. doi:10.2355/isijinternational.33.26

[35] Zaitsev AI, Litvina AD, Lyakishev NP, Mogutnov BM. Thermodynamics of CaO-Al2O3-SiO2 and CaF2-CaO-Al2O3-SiO2 melts. J Chem Soc Faraday Trans. 1997;93(17):3089-3098. doi:10.1039/a700511c

[36] Barin I. Thermochemical Data of Pure Substances. 3rd ed. Weinheim: VCH; 1995. doi:10.1002/9783527619825

[37] Hersh LS, Kleppa OJ. Enthalpies of Mixing in Some Binary Liquid Halide Mixtures. J Chem Phys. 1965;42:1309. doi:10.1063/1.1696115

[38] Sangster J, Pelton AD. Phase Diagrams and Thermodynamic Properties of the 70 Binary Alkali Halide Systems Having Common Ions. J Phys Chem Ref Data. 1987;16:509. doi:10.1063/1.555803

[39] Ard JC, Yingling JA, Johnson TJ, Schorne-Pinto J, Aziziha M, Dixon CM, et al. Development of the Molten Salt Thermal Properties Database - Thermochemical (MSTDB-TC), example applications, and LiCl-RbCl and UF3-UF4 system assessments. J Nucl Mater. 2022 May;563:153631. doi:10.1016/j.jnucmat.2022.153631

[40] Rankin GA. The ternary system CaO-Al2O3-SiO2, with optical study by F. E. Wright. Am J Sci. 1915;s4-39(229):1-79. doi:10.2475/ajs.s4-39.229.1

[41] an Mey S. Reevaluation of the Al-Zn system. Z Metallkd. 1993;84(7):451-5. doi:10.1515/ijmr-1993-840704

[42] Goodwin DG, Moffat HK, Schoegl I, Speth RL, Weber BW. Cantera: An Object-oriented Software Toolkit for Chemical Kinetics, Thermodynamics, and Transport Processes. Version 3.1.0; 2024. doi:10.5281/zenodo.14455267

[43] Dinsdale AT. SGTE data for pure elements. Calphad. 1991 Oct;15(4):317-425. doi:10.1016/0364-5916(91)90030-N

[44] McBride BJ, Zehe MJ, Gordon S. NASA Glenn Coefficients for Calculating Thermodynamic Properties of Individual Species. NASA/TP-2002-211556. Cleveland (OH): NASA Glenn Research Center; 2002.

[45] Smith GP, Golden DM, Frenklach M, Moriarty NW, Eiteneer B, Goldenberg M, et al. GRI-Mech 3.0 [Internet]. 1999. Available from: http://combustion.berkeley.edu/gri-mech/

[46] Dinsdale A, Zobac O, Kroupa A, Khvan A. Use of third generation data for the elements to model the thermodynamics of binary alloy systems: Part 1 - The critical assessment of data for the Al-Zn system. Calphad. 2020 Mar;68:101723. doi:10.1016/j.calphad.2019.101723

[47] Massalski TB, editor. Binary Alloy Phase Diagrams. 2nd ed. Materials Park (OH): ASM International; 1990.

[48] Chen Q, Sundman B. Modeling of thermodynamic properties for Bcc, Fcc, liquid, and amorphous iron. J Phase Equilibria. 2001 Nov;22(6):631-44. doi:10.1007/s11669-001-0027-9

[49] He Z, Kaplan B, Mao H, Selleby M. The third generation Calphad description of Al-C including revisions of pure Al and C. Calphad. 2021 Mar;72:102250. doi:10.1016/j.calphad.2021.102250

[50] Ngai TL, Chang YA. A thermodynamic analysis of the Pb-Sn system and the calculation of the Pb-Sn phase diagram. Calphad. 1981;5(4):267-76. doi:10.1016/0364-5916(81)90009-2
