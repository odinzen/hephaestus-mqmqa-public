...
| Gas phase | NASA-polynomial ideal-gas equilibria, C-H-O feeds (Python and C core) | Cantera [40] parity to 10^-10^ (Python), 10^-6^ (C/browser), 1200-3000 K, 0.1-10 atm |
