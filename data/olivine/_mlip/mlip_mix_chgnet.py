...
print(f'CHGNet: {base.get_chemical_formula()}, {n} M-sites',flush=True)
for k in (0,2,4,6,8):
...
print('\n x     CHGNet H_mix  Wood-Kleppa   diff')
...
print(f'\nCHGNet RK: L0={L0:.0f} L1={L1:.0f} vs WK 12552,4184; RMS(CHGNet-WK)={rms:.0f} J/mol')
