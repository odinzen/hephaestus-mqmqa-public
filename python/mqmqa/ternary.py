...
def cef_line_points(cdb, phase, T, x_si_line, n_cations, n=61):
    ...
    cef_gibbs per-formula value divides by. (The enstatite high-T entropy correction that
    used to ride here as a callable now lives in the database as a second Gibbs interval.)"""
